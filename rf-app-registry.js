  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'page', key:'kpi', label:'KPI PRODUCȚIE', href:'kpi.html' },
        { type:'page', key:'kpi-livrari', label:'KPI LIVRĂRI', href:'kpi-livrari.html' },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'quality-pages', label:'Calitate / Rebut', items:[ ['magnaflux','MAGNAFLUX'],['magnaflux-operatori','MAGNAFLUX OPERATORI'],['duritate','DURITATE'],['magnaflux-calendar','MAGNAFLUX CALENDAR'],['rebut','REBUT'],['rebut-pm-operatori','REBUT PM OPERATORI'],['analiza-rebut-calitate','ANALIZĂ REBUT CALITATE'],['rebut-pm','REBUT PM'],['rebut-pm-helper','REBUT PM HELPER'],['calendar-operatori','CALENDAR OPERATORI'] ] },
