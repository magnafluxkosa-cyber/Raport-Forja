  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-calitate', label:'CALITATE', panelId:'subCalitate', panelMode:'flat', sections:[{ key:'group-calitate-links', label:'Pagini', sectionId:'calitateLinks', layout:'subgrid', items:[ page('magnaflux','MAGNAFLUX'), page('magnaflux-operatori','MAGNAFLUX OPERATORI'), page('magnaflux-calendar','MAGNAFLUX CALENDAR'), page('duritate','DURITATE'), page('fisa-control-ctc-forja','FISA DE CONTROL CTC FORJA'), page('probleme-ctc-forja','PROBLEME CTC FORJA'), page('rebut','REBUT'), page('rebut-pm-helper','REBUT PM HELPER'), page('rebut-pm-operatori','REBUT PM OPERATORI'), page('analiza-rebut-calitate','ANALIZĂ REBUT CALITATE'), page('arhiva-documente','ARHIVĂ DOCUMENTE') ] }] },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'quality-pages', label:'Calitate / Rebut', items:[ ['magnaflux','MAGNAFLUX'],['magnaflux-operatori','MAGNAFLUX OPERATORI'],['duritate','DURITATE'],['magnaflux-calendar','MAGNAFLUX CALENDAR'],['fisa-control-ctc-forja','FISA DE CONTROL CTC FORJA'],['probleme-ctc-forja','PROBLEME CTC FORJA'],['rebut','REBUT'],['rebut-pm-operatori','REBUT PM OPERATORI'],['analiza-rebut-calitate','ANALIZĂ REBUT CALITATE'],['arhiva-documente','ARHIVĂ DOCUMENTE'],['rebut-pm','REBUT PM'],['rebut-pm-helper','REBUT PM HELPER'],['calendar-operatori','CALENDAR OPERATORI'] ] },
        ...
        { key:'helper-pages', label:'Administrator', items:[ ['index','DASHBOARD'],['helper','HELPER'],['helper-data','HELPER-DATA'],['helper-acl','HELPER-ACL'],['mapare-nume-notificari','MAPARE NUME NOTIFICĂRI'],['istoric-notificari','ISTORIC NOTIFICĂRI'],['arhiva-digitala','ARHIVĂ DIGITALĂ'],['backup-date-kad','BACKUP DATE K.A.D'],['kad_system_presentation','K.A.D PREZENTARE'] ] }
      ]
    }
  };
