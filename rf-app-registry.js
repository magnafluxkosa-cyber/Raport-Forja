  ...
  var registry = {
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'manuale-instructiuni-pages', label:'Manuale / Instrucțiuni', items:[ ['manual-cm-315t','Manual CM 3.15 T'], ['manual-cm-25t','Manual CM 2.5 T'] ] },
