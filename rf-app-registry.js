  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-calitate', label:'CALITATE', panelId:'subCalitate', panelMode:'flat', sections:[{ key:'group-calitate-links', label:'Pagini', sectionId:'calitateLinks', layout:'subgrid', items:[ page('magnaflux','MAGNAFLUX'), page('magnaflux-operatori','MAGNAFLUX OPERATORI'), page('duritate','DURITATE'), page('fisa-control-ctc-forja','FISA DE CONTROL CTC FORJA'), page('probleme-ctc-forja','PROBLEME CTC FORJA'), page('rebut','REBUT'), page('rebut-pm-helper','REBUT PM HELPER'), page('rebut-pm-operatori','REBUT PM OPERATORI'), page('analiza-rebut-calitate','ANALIZĂ REBUT CALITATE') ] }] },
        ...
        { type:'page', key:'operatori', label:'OPERATORI', href:'operatori.html' },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'operatori-pages', label:'Operatori / Fișe operatori', items:[ ['operatori','OPERATORI / FIȘE OPERATORI'] ] },
