      ...
      items: [
        {
          type:'group', key:'group-forja', label:'FORJĂ', panelId:'subForja', panelMode:'tabs', sections:[
            ...
            { key:'group-forja-inventar', buttonKey:'group-forja-inventar', label:'INVENTAR', sectionId:'forjaInventar', layout:'subgrid', items:[
              page('inventar-otel','INVENTAR OȚEL'), page('inventar-debitat','INVENTAR DEBITAT'), page('inventar-forjat','INVENTAR FORJAT'), page('stoc-ramas-teoretic','STOC RĂMAS TEORETIC'), page('stoc-general-real','STOC GENERAL REAL')
            ]}
          ]
        },
