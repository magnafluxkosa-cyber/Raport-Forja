  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-calitate', label:'CALITATE', panelId:'subCalitate', panelMode:'flat', sections:[{ key:'group-calitate-links', label:'Pagini', sectionId:'calitateLinks', layout:'subgrid', items:[ page('magnaflux','MAGNAFLUX'), page('duritate','DURITATE'), page('rebut','REBUT') ] }] },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'quality-pages', label:'Calitate / Rebut', items:[ ['magnaflux','MAGNAFLUX'],['duritate','DURITATE'],['magnaflux-calendar','MAGNAFLUX CALENDAR'],['rebut','REBUT'],['rebut-pm','REBUT PM'],['rebut-pm-helper','REBUT PM HELPER'],['calendar-operatori','CALENDAR OPERATORI'] ] },
