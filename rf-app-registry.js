  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-resurse-umane', label:'RESURSE UMANE', panelId:'subResurseUmane', panelMode:'tabs', sections:[{ key:'group-resurse-umane-pontaje', buttonKey:'group-resurse-umane-pontaje', label:'PONTAJE', sectionId:'resurseUmanePontaje', layout:'subgrid', items:[ page('pontaj-forja','PONTAJ FORJA'), page('pontaj-prelucrari-mecanice','PONTAJ PRELUCRĂRI MECANICE') ] }] },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'resurse-umane-pages', label:'Resurse umane / Pontaje', items:[ ['pontaj-forja','PONTAJ FORJA'],['pontaj-prelucrari-mecanice','PONTAJ PRELUCRĂRI MECANICE'] ] },
