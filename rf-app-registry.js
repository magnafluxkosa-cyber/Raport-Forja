  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-calitate', label:'CALITATE', panelId:'subCalitate', panelMode:'flat', sections:[{ key:'group-calitate-links', label:'Pagini', sectionId:'calitateLinks', layout:'subgrid', items:[ page('magnaflux','MAGNAFLUX'), page('magnaflux-operatori','MAGNAFLUX OPERATORI'), page('magnaflux-calendar','MAGNAFLUX CALENDAR'), page('duritate','DURITATE'), page('capabilitate-proces-forjare','CAPABILITATE PROCES FORJARE'), page('fisa-control-ctc-forja','FISA DE CONTROL CTC FORJA'), page('probleme-ctc-forja','PROBLEME CTC FORJA'), page('rebut','REBUT'), page('rebut-pm-helper','REBUT PM HELPER'), page('rebut-pm-operatori','REBUT PM OPERATORI'), page('analiza-rebut-calitate','ANALIZĂ REBUT CALITATE') ] }] },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'quality-pages', label:'Calitate / Rebut', items:[ ['magnaflux','MAGNAFLUX'],['magnaflux-operatori','MAGNAFLUX OPERATORI'],['duritate','DURITATE'],['capabilitate-proces-forjare','CAPABILITATE PROCES FORJARE'],['magnaflux-calendar','MAGNAFLUX CALENDAR'],['fisa-control-ctc-forja','FISA DE CONTROL CTC FORJA'],['probleme-ctc-forja','PROBLEME CTC FORJA'],['rebut','REBUT'],['rebut-pm-operatori','REBUT PM OPERATORI'],['analiza-rebut-calitate','ANALIZĂ REBUT CALITATE'],['rebut-pm','REBUT PM'],['rebut-pm-helper','REBUT PM HELPER'],['calendar-operatori','CALENDAR OPERATORI'] ] },
