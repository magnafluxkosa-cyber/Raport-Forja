(function(window){
  ...
  var registry = {
      ...
      items: [
        {
          type:'group', key:'group-forja', label:'FORJĂ', panelId:'subForja', panelMode:'tabs', sections:[
            { key:'group-forja-rapoarte', buttonKey:'group-forja-rapoarte', label:'RAPOARTE', sectionId:'forjaRapoarte', layout:'subgrid', items:[
              page('raport-forja','Raport forja'), page('arhiva-rapoarte-productie','ARHIVĂ RAPOARTE PRODUCȚIE'), page('numeralkod','NUMERALKOD'), page('intrari-otel','INTRĂRI OȚEL'), page('debitate','DEBITATE'), page('forjate','FORJATE'), page('eficienta','EFICIENȚĂ'), page('program-utilaje','PROGRAM UTILAJE')
            ]},
    ...
    helperAcl: {
      buttonGroups: [],
      pageGroups: [
        { key:'forja-pages', label:'Foi FORJĂ', items:[ ['raport-forja','Raport forja'],['arhiva-rapoarte-productie','ARHIVĂ RAPOARTE PRODUCȚIE'],['numeralkod','NUMERALKOD'],['intrari-otel','INTRĂRI OȚEL'],['debitate','DEBITATE'],['forjate','FORJATE'],['eficienta','EFICIENȚĂ'],['program-utilaje','PROGRAM UTILAJE'],['stoc-initial-otel','STOC INIȚIAL OȚEL'],['inventar-otel','INVENTAR OȚEL'],['inventar-debitat','INVENTAR DEBITAT'],['inventar-forjat','INVENTAR FORJAT'] ] },
