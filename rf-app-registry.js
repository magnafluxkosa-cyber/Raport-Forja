  ...
  var registry = {
    index: {
      items: [
        ...
        { type:'group', key:'group-prelucrari', label:'PRELUCRĂRI MECANICE', panelId:'subPrelucrari', panelMode:'flat', sections:[{ key:'group-prelucrari-links', label:'Pagini', sectionId:'prelucrariLinks', layout:'subgrid', items:[ page('plan-livrari','PLAN LIVRĂRI'), page('planificare-prelucrari','PLANIFICARE PRELUCRĂRI'), page('inventar-prelucrari','INVENTAR PRELUCRĂRI'), page('raport-pm','RAPORT PM') ] }] },
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'prelucrari-pages', label:'Foi PRELUCRĂRI MECANICE', items:[ ['plan-livrari','PLAN LIVRĂRI'],['planificare-prelucrari','PLANIFICARE PRELUCRĂRI'],['inventar-prelucrari','INVENTAR PRELUCRĂRI'],['raport-pm','RAPORT PM'] ] },
