  ...
  var registry = {
    ...
    helperAcl: {
      ...
      pageGroups: [
        ...
        { key:'helper-pages', label:'Administrator', items:[ ['helper','HELPER'],['helper-data','HELPER-DATA'],['helper-acl','HELPER-ACL'],['mapare-nume-notificari','MAPARE NUME NOTIFICĂRI'],['istoric-notificari','ISTORIC NOTIFICĂRI'],['arhiva-digitala','ARHIVĂ DIGITALĂ'] ] }
      ]
    }
  };
