...
function getControlCatalogForPage(pageKey) {
  ...
  var DEFAULT_THEME_KEY = 'neon-blue';

  var FEATURED_THEME_KEYS = Object.freeze(['neon-blue','neon-cyan','neon-amber']);

  var THEME_PALETTES = Object.freeze({

    'neon-blue': Object.freeze({
  key: 'neon-blue',
  label: 'Neon albastru',
  colorScheme: 'dark',
  previewA: '#1e5bff',
  previewB: '#7fe0ff',
  bodyBackground: 'radial-gradient(circle at 18% 18%, rgba(41,104,255,.22), transparent 24%), radial-gradient(circle at 82% 14%, rgba(86,195,255,.16), transparent 18%), radial-gradient(circle at 50% 100%, rgba(20,52,132,.28), transparent 28%), linear-gradient(180deg,#030913 0%, #07152a 48%, #0a1c36 100%)',
  bgSolid: '#071327',
  card: 'rgba(8,23,48,.76)',
  panel: 'rgba(8,23,48,.76)',
  panel2: 'rgba(7,18,40,.84)',
  hdr: 'rgba(12,29,60,.94)',
  header: 'rgba(10,26,54,.96)',
  subheader: 'rgba(8,21,43,.92)',
  head: 'rgba(13,34,69,.94)',
  head2: 'rgba(8,24,50,.92)',
  cell: 'rgba(6,19,40,.84)',
  sticky: 'rgba(9,26,53,.97)',
  grid: 'rgba(77,141,255,.14)',
  line: 'rgba(104,161,255,.42)',
  lineSoft: 'rgba(90,146,255,.16)',
  lineStrong: 'rgba(110,173,255,.30)',
  text: '#eef7ff',
  muted: '#8fa9d6',
  input: 'rgba(9,26,51,.92)',
  white: 'rgba(6,18,40,.92)',
  btn: '#2f6bff',
  btn2: '#133fc8',
  btnHover: '#4b88ff',
  btnSoft: 'rgba(26,59,136,.42)',
  focus: '#71c9ff',
  statusBg: 'rgba(7,19,39,.86)',
  statusText: '#71c9ff',
  shadow: '0 20px 54px rgba(2,8,23,.56), 0 0 30px rgba(33,99,255,.18)',
  rowHover: 'rgba(47,107,255,.18)',
  rowSelected: 'rgba(72,132,255,.24)',
  selected: 'rgba(74,135,255,.20)',
  selectedBorder: 'rgba(114,191,255,.56)',
  panelBorder: 'rgba(92,150,255,.22)',
  blue: '#2f6bff',
  blueDark: '#133fc8',
  green: '#17b57b',
  yellow: '#ffb74d',
  ...
  bad: '#ff5f78',
  orange: '#ff9f43',
  chip: 'rgba(47,107,255,.18)',
  pill: 'rgba(8,24,52,.88)',
  bg1: '#031126',
  bg2: '#0b2d63',
  bg3: '#2f6bff',
  shellAccent: '#2f6bff',
  shellAccent2: '#71c9ff',
  shellBg: 'rgba(5,18,38,.94)',
  shellBg2: 'rgba(8,28,57,.96)',
  shellBorder: 'rgba(110,173,255,.22)',
  shellText: '#eef7ff',
  shellMuted: 'rgba(211,230,255,.72)',
  shellSurface: 'rgba(255,255,255,.05)',
  shellSurfaceHover: 'rgba(35,81,196,.92)',
  shellSurfaceBorder: 'rgba(114,191,255,.18)',
  shellDivider: 'rgba(114,191,255,.14)',
  shellShadow: '0 28px 70px rgba(2,10,28,.54)',
  shellCaret: 'rgba(225,241,255,.88)',
  shellScroll: 'rgba(83,138,255,.34)',
  shellShine1: 'rgba(255,255,255,.05)',
  shellShine2: 'rgba(114,191,255,.16)'
}),
    'neon-cyan': Object.freeze({
  key: 'neon-cyan',
  label: 'Neon cyan',
  colorScheme: 'dark',
  previewA: '#00d5ff',
  previewB: '#7dfff3',
  bodyBackground: 'radial-gradient(circle at 20% 14%, rgba(0,213,255,.18), transparent 22%), radial-gradient(circle at 80% 12%, rgba(77,255,231,.14), transparent 18%), radial-gradient(circle at 50% 100%, rgba(0,84,104,.26), transparent 26%), linear-gradient(180deg,#031014 0%, #041a22 52%, #07242d 100%)',
  bgSolid: '#07171d',
  card: 'rgba(6,27,34,.78)',
  panel: 'rgba(6,27,34,.78)',
  panel2: 'rgba(5,21,28,.86)',
  hdr: 'rgba(9,34,42,.94)',
  header: 'rgba(8,30,37,.96)',
  subheader: 'rgba(6,24,31,.92)',
  head: 'rgba(10,39,48,.94)',
  head2: 'rgba(7,27,34,.92)',
  cell: 'rgba(5,21,27,.86)',
  sticky: 'rgba(8,29,36,.97)',
  grid: 'rgba(58,208,222,.15)',
  line: 'rgba(92,237,255,.42)',
  lineSoft: 'rgba(58,208,222,.16)',
  lineStrong: 'rgba(92,237,255,.28)',
  text: '#ecfffe',
  muted: '#89c6c9',
  input: 'rgba(7,24,31,.92)',
  white: 'rgba(6,18,24,.92)',
  btn: '#00c6dd',
  btn2: '#008ca4',
  btnHover: '#31e5f7',
  btnSoft: 'rgba(0,142,166,.40)',
  focus: '#7dfff3',
  statusBg: 'rgba(7,23,29,.86)',
  statusText: '#7dfff3',
  shadow: '0 20px 54px rgba(2,11,14,.56), 0 0 32px rgba(0,198,221,.18)',
  rowHover: 'rgba(0,198,221,.16)',
  rowSelected: 'rgba(39,225,239,.22)',
  selected: 'rgba(39,225,239,.18)',
  selectedBorder: 'rgba(125,255,243,.46)',
  panelBorder: 'rgba(74,224,230,.20)',
  blue: '#00c6dd',
  blueDark: '#008ca4',
  green: '#32d583',
  yellow: '#ffbe5c',
  ...
  bad: '#ff6176',
  orange: '#ff9f43',
  chip: 'rgba(0,198,221,.18)',
  pill: 'rgba(6,22,29,.88)',
  bg1: '#031319',
  bg2: '#05404d',
  bg3: '#00c6dd',
  shellAccent: '#00c6dd',
  shellAccent2: '#7dfff3',
  shellBg: 'rgba(4,20,26,.94)',
  shellBg2: 'rgba(7,30,37,.96)',
  shellBorder: 'rgba(92,237,255,.22)',
  shellText: '#ecfffe',
  shellMuted: 'rgba(208,255,250,.70)',
  shellSurface: 'rgba(255,255,255,.05)',
  shellSurfaceHover: 'rgba(0,110,128,.92)',
  shellSurfaceBorder: 'rgba(125,255,243,.18)',
  shellDivider: 'rgba(125,255,243,.14)',
  shellShadow: '0 28px 70px rgba(2,11,14,.54)',
  shellCaret: 'rgba(226,255,251,.88)',
  shellScroll: 'rgba(0,198,221,.34)',
  shellShine1: 'rgba(255,255,255,.05)',
  shellShine2: 'rgba(125,255,243,.15)'
}),
    'neon-amber': Object.freeze({
  key: 'neon-amber',
  label: 'Neon amber',
  colorScheme: 'dark',
  previewA: '#ff9e2c',
  previewB: '#ffd36a',
  bodyBackground: 'radial-gradient(circle at 18% 16%, rgba(255,163,54,.18), transparent 24%), radial-gradient(circle at 82% 12%, rgba(255,115,32,.14), transparent 18%), radial-gradient(circle at 50% 100%, rgba(124,46,10,.26), transparent 26%), linear-gradient(180deg,#110604 0%, #1a0a08 52%, #25100c 100%)',
  bgSolid: '#190b08',
  card: 'rgba(30,13,10,.80)',
  panel: 'rgba(30,13,10,.80)',
  panel2: 'rgba(23,10,8,.88)',
  hdr: 'rgba(38,16,12,.95)',
  header: 'rgba(33,14,11,.96)',
  subheader: 'rgba(28,12,9,.92)',
  head: 'rgba(43,19,14,.94)',
  head2: 'rgba(31,13,10,.92)',
  cell: 'rgba(25,11,8,.88)',
  sticky: 'rgba(31,13,10,.97)',
  grid: 'rgba(255,163,54,.14)',
  line: 'rgba(255,196,103,.40)',
  lineSoft: 'rgba(255,163,54,.16)',
  lineStrong: 'rgba(255,196,103,.30)',
  text: '#fff1df',
  muted: '#d9b796',
  input: 'rgba(31,14,10,.92)',
  white: 'rgba(24,11,8,.92)',
  btn: '#ff9e2c',
  btn2: '#db6c12',
  btnHover: '#ffb454',
  btnSoft: 'rgba(184,85,18,.40)',
  focus: '#ffd36a',
  statusBg: 'rgba(29,12,9,.86)',
  statusText: '#ffd36a',
  shadow: '0 20px 54px rgba(14,6,4,.58), 0 0 30px rgba(255,145,44,.16)',
  rowHover: 'rgba(255,158,44,.16)',
  rowSelected: 'rgba(255,179,84,.22)',
  selected: 'rgba(255,179,84,.18)',
  selectedBorder: 'rgba(255,211,106,.52)',
  panelBorder: 'rgba(255,175,74,.20)',
  blue: '#ff9e2c',
  blueDark: '#db6c12',
  green: '#2ecc71',
  yellow: '#ffd36a',
  ...
  bad: '#ff6a57',
  orange: '#ff9e2c',
  chip: 'rgba(255,158,44,.18)',
  pill: 'rgba(30,13,10,.88)',
  bg1: '#140705',
  bg2: '#51210f',
  bg3: '#ff9e2c',
  shellAccent: '#ff9e2c',
  shellAccent2: '#ffd36a',
  shellBg: 'rgba(24,11,8,.94)',
  shellBg2: 'rgba(36,15,11,.96)',
  shellBorder: 'rgba(255,196,103,.22)',
  shellText: '#fff1df',
  shellMuted: 'rgba(255,226,197,.70)',
  shellSurface: 'rgba(255,255,255,.05)',
  shellSurfaceHover: 'rgba(126,52,8,.92)',
  shellSurfaceBorder: 'rgba(255,211,106,.18)',
  shellDivider: 'rgba(255,211,106,.14)',
  shellShadow: '0 28px 70px rgba(14,6,4,.54)',
  shellCaret: 'rgba(255,241,223,.88)',
  shellScroll: 'rgba(255,158,44,.34)',
  shellShine1: 'rgba(255,255,255,.04)',
  shellShine2: 'rgba(255,211,106,.14)'
}),
    blue: Object.freeze({
      key: 'blue',
      label: 'Albastru',
  ...
  function buildPaletteCss(key, palette) {
    return [
      ...
      '  color-scheme:' + (palette.colorScheme || 'light') + ';',
      '  --bg:' + palette.bgSolid + ';',
      '  --card:' + palette.card + ';',
      '  --panel:' + palette.panel + ';',
      ...
      '  --chip:' + palette.chip + ';',
      '  --pill:' + palette.pill + ';',
      '  --bg1:' + (palette.bg1 || palette.btn2 || palette.blueDark || palette.bgSolid) + ';',
      '  --bg2:' + (palette.bg2 || palette.btn || palette.blue || palette.bgSolid) + ';',
      '  --bg3:' + (palette.bg3 || palette.focus || palette.btn || palette.blue) + ';',
      '  --danger-hover:' + (palette.dangerHover || palette.bad || palette.danger) + ';',
      '  --kad-shell-bg:' + (palette.shellBg || palette.panel2 || palette.panel) + ';',
      '  --kad-shell-bg-2:' + (palette.shellBg2 || palette.panel || palette.panel2) + ';',
      '  --kad-shell-border:' + (palette.shellBorder || palette.panelBorder || palette.lineStrong) + ';',
      '  --kad-shell-divider:' + (palette.shellDivider || palette.lineSoft || palette.lineStrong) + ';',
      '  --kad-shell-text:' + (palette.shellText || palette.text) + ';',
      '  --kad-shell-muted:' + (palette.shellMuted || palette.muted) + ';',
      '  --kad-shell-shadow:' + (palette.shellShadow || palette.shadow) + ';',
      '  --kad-shell-surface:' + (palette.shellSurface || palette.btnSoft || palette.white) + ';',
      '  --kad-shell-surface-hover:' + (palette.shellSurfaceHover || palette.btn2 || palette.btn) + ';',
      '  --kad-shell-surface-border:' + (palette.shellSurfaceBorder || palette.panelBorder || palette.lineStrong) + ';',
      '  --kad-shell-caret:' + (palette.shellCaret || palette.text) + ';',
      '  --kad-shell-scroll:' + (palette.shellScroll || palette.lineStrong || palette.line) + ';',
      '  --kad-shell-shine-1:' + (palette.shellShine1 || 'rgba(255,255,255,.05)') + ';',
      '  --kad-shell-shine-2:' + (palette.shellShine2 || palette.chip || palette.pill) + ';',
      '  --kad-shell-accent:' + (palette.shellAccent || palette.btn) + ';',
      '  --kad-shell-accent-2:' + (palette.shellAccent2 || palette.focus || palette.btnHover) + ';',
      '}',
  ...
  function buildSharedThemeCss() {
    return [
      ...
      '}',
      'html[data-rf-theme] .toolbar,',
      'html[data-rf-theme] .toolbar-card,',
      'html[data-rf-theme] .bucketHead,',
      'html[data-rf-theme] .topbar{',
      '  color:var(--text) !important;',
      '}',
      'html[data-rf-theme] .bucketTitle,',
      'html[data-rf-theme] .bucketSub,',
      'html[data-rf-theme] .hint,',
      'html[data-rf-theme] .theme-name,',
      'html[data-rf-theme] .theme-note{',
      '  color:var(--text) !important;',
      '}',
      'html[data-rf-theme] button,',
      'html[data-rf-theme] .btn,',
      'html[data-rf-theme] .btnMini,',
      'html[data-rf-theme] .iconbtn{',
      '  background:var(--btn-soft) !important;',
      '  color:var(--text) !important;',
      '  border-color:var(--line-strong) !important;',
      '  box-shadow:var(--shadow) !important;',
      '}',
      'html[data-rf-theme] .btn:hover,',
      'html[data-rf-theme] .btnMini:hover,',
      'html[data-rf-theme] .iconbtn:hover,',
      'html[data-rf-theme] button:hover{',
      '  filter:brightness(1.04) !important;',
      '}',
      'html[data-rf-theme] .btnDark,',
      'html[data-rf-theme] .btnAdd,',
      'html[data-rf-theme] .main-btn,',
      'html[data-rf-theme] .theme-btn{',
      '  background:linear-gradient(180deg,var(--btn),var(--btn2)) !important;',
      '  color:#f4f8ff !important;',
      ...
      '}',
      'html[data-rf-theme] .btnDel,',
      'html[data-rf-theme] .danger,',
      'html[data-rf-theme] .iconbtn.danger{',
      '  background:linear-gradient(180deg,var(--danger),var(--bad)) !important;',
      '  color:#fff2f4 !important;',
      '  border-color:transparent !important;',
      '}',
      'html[data-rf-theme] .badgeCloud.ok,',
      'html[data-rf-theme] .cloudBadge{',
...
async function applyDomPermissions(pageKey, root, options) {
  ...
  window.RF_THEME.featuredKeys = FEATURED_THEME_KEYS.slice();
  window.RF_THEME.list = getThemeList;
  window.RF_THEME.getFeaturedList = function(){
    return FEATURED_THEME_KEYS.filter(function(key){ return !!THEME_PALETTES[key]; }).map(function(key){
      var palette = THEME_PALETTES[key];
      return Object.freeze({ key:key, label:palette.label, previewA:palette.previewA, previewB:palette.previewB });
    });
  };
